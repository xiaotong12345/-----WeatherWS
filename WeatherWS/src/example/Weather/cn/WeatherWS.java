 ...
 * 
 */
@WebServiceClient(name = "WeatherWS", targetNamespace = "http://WebXml.com.cn/", wsdlLocation = "file:/D:/code--idea/master/calculate-tax-web-service-master/src/example/Weather/Weather.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("file:/D:/code--idea/master/calculate-tax-web-service-master/src/example/Weather/Weather.wsdl");
